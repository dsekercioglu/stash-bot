...
enum
{
	...
	MobilityN_Base = SPAIR(-40, -50),
	MobilityN_Quad = SPAIR(60, 90),
	MobilityB_Base = SPAIR(-40, -50),
	MobilityB_Quad = SPAIR(70, 105),
	MobilityR_Base = SPAIR(-45, -70),
	MobilityR_Quad = SPAIR(90, 130),
	MobilityQ_Base = SPAIR(-25, -90),
	MobilityQ_Quad = SPAIR(50, 190),
