...
enum
{
	CastlingBonus = SPAIR(71, -20),
	Initiative = 3,

	MobB_Base = SPAIR(-27, -85),
	MobB_Plus = SPAIR(4, 14),
	MobB_Moves = 8,
	MobR_Base = SPAIR(-73, -45),
	MobR_Plus = SPAIR(1, 14),
	MobR_Moves = 11,
	MobQ_Base = SPAIR(-57, 78),
	MobQ_Plus = SPAIR(0, 28),
	MobQ_Moves = 14,
	...
	BishopPair = SPAIR(60, 116),
	KnightPair = SPAIR(22, 17),
	RookPair = SPAIR(-42, -72),
	NonPawnBonus = SPAIR(87, 165),

	RookOnSemiOpenFile = SPAIR(38, 28),
	RookOnOpenFile = SPAIR(100, 43),
	RookXrayQueen = SPAIR(4, 47),
