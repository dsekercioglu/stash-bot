...
const scorepair_t BackwardPenalty  = SPAIR( -3,-11);
const scorepair_t StragglerPenalty = SPAIR(-17,-18);
const scorepair_t DoubledPenalty   = SPAIR(-25,-35);
const scorepair_t IsolatedPenalty  = SPAIR(-10, -7);
