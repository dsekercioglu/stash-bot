...
const scorepair_t BackwardPenalty = SPAIR(-8, -6);
const scorepair_t StragglerPenalty = SPAIR(-11, -30);
const scorepair_t DoubledPenalty = SPAIR(-19, -33);
const scorepair_t IsolatedPenalty = SPAIR(-6, -7);
