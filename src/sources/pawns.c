...
const scorepair_t BackwardPenalty = SPAIR(-5, -11);
const scorepair_t StragglerPenalty = SPAIR(-17, -24);
const scorepair_t DoubledPenalty = SPAIR(-29, -50);
const scorepair_t IsolatedPenalty = SPAIR(-12, -21);
