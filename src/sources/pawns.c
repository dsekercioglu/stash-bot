...
const scorepair_t BackwardPenalty = SPAIR(-8, -4);
const scorepair_t StragglerPenalty = SPAIR(-26, -23);
const scorepair_t DoubledPenalty = SPAIR(-26, -54);
const scorepair_t IsolatedPenalty = SPAIR(-16, -20);
