...
const scorepair_t BackwardPenalty = SPAIR(-6, -11);
const scorepair_t StragglerPenalty = SPAIR(-19, -27);
const scorepair_t DoubledPenalty = SPAIR(-35, -43);
const scorepair_t IsolatedPenalty = SPAIR(-3, -6);
