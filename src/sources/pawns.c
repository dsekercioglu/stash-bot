...
const scorepair_t BackwardPenalty = SPAIR(-17, -4);
const scorepair_t StragglerPenalty = SPAIR(-31, -15);
const scorepair_t DoubledPenalty = SPAIR(-41, -43);
const scorepair_t IsolatedPenalty = SPAIR(2, -21);
