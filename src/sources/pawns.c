...
const scorepair_t BackwardPenalty = SPAIR(-6, -1);
const scorepair_t StragglerPenalty = SPAIR(-21, -23);
const scorepair_t DoubledPenalty = SPAIR(-29, -48);
const scorepair_t IsolatedPenalty = SPAIR(-17, -20);
