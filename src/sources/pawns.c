...
const scorepair_t BackwardPenalty  = SPAIR( -9, -5);
const scorepair_t StragglerPenalty = SPAIR(-15,-28);
const scorepair_t DoubledPenalty   = SPAIR(-17,-39);
const scorepair_t IsolatedPenalty  = SPAIR(-11, -9);
