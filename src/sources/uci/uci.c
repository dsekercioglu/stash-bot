...
void	uci_loop(int argc, char **argv)
{
	...
	add_option_spin_int(&g_opthandler, "Move Overhead", &g_options.move_overhead, 30, 0, 30000, NULL);
	add_option_spin_flt(&g_opthandler, "TimeburnRatio", &g_options.burn_ratio, 1.4, 0.1, 10, NULL);
