...
typedef enum tune_idx_e
{
    ...
    IDX_ISOLATED,
    IDX_PASSER,
    IDX_PHALANX = IDX_PASSER + 24,
    IDX_DEFENDER = IDX_PHALANX + 6,
    IDX_PP_OUR_KING_PROX = IDX_DEFENDER + 5,
    IDX_PP_THEIR_KING_PROX = IDX_PP_OUR_KING_PROX + 7,
    IDX_PP_STOP_CONTROL = IDX_PP_THEIR_KING_PROX + 7,
    IDX_PP_CONNECTED = IDX_PP_STOP_CONTROL + 24,
    IDX_PP_TARRASCH_US = IDX_PP_CONNECTED + 6,
    IDX_PP_TARRASCH_THEM = IDX_PP_TARRASCH_US + 6,
    IDX_KS_KNIGHT = IDX_PP_TARRASCH_THEM + 6,
    IDX_KS_BISHOP,
    IDX_KS_ROOK,
    IDX_KS_QUEEN,
    IDX_KS_ATTACK,
