...
INLINED void    add_cp_history(capture_history_t hist, piece_t pc, square_t to,
                piecetype_t captured, int32_t bonus)
{
...
INLINED score_t get_cp_history_score(const capture_history_t hist, piece_t pc, square_t to,
